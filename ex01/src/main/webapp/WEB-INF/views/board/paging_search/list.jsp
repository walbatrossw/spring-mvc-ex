                ...
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        ...
                        <table class="table table-bordered">
                            ...
                            <tr>
                                <td>${boardVO.bno}</td>
                                <td><a href="${path}/board/paging/search/read${pageMaker.makeSearch(pageMaker.criteria.page)}&bno=${boardVO.bno}">${boardVO.title}</a></td>
                        ...
                        <div class="text-center">
                            <ul class="pagination">
                                ...
                                <c:if test="${pageMaker.prev}">
                                    <%--UriComponents를 사용--%>
                                    <li><a href="${path}/board/paging/search/list${pageMaker.makeSearch(pageMaker.startPage-1)}">&laquo;</a></li>
                                </c:if>
                                <%--시작 페이지 ~ 마지막 페이지까지 반복--%>
                                ...
                                <c:if test="${pageMaker.next && pageMaker.endPage > 0}">
                                    <%--UriComponents를 사용--%>
                                    <li><a href="${path}/board/paging/search/list${pageMaker.makeSearch(pageMaker.endPage + 1)}">&raquo;</a></li>
                                </c:if>
                            </ul>
                        </div>
                    </div>
...
<script>
    ...
    $(document).ready(function () {
        ...
        $("#writeBtn").on("click", function (event) {
            ...
            self.location = "${path}/board/paging/search/register";
