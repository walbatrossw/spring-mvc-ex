        ...
        <section class="content container-fluid">
            ...
            <div class="col-lg-12">
                    ...
                    <div class="box box-primary">
                        ...
                        <form role="form" method="post" action="${path}/board/paging/modify">
                            <div class="box-body">

                                <%--이전의 목록 페이지 정보를 가지고 페이지 이동을 위한 값들 세팅--%>
...
<script>
    $(document).ready(function () {
        ...
        $(".cancelBtn").on("click", function () {
            history.go(-1); // <iframe>의 내부에 있을 경우 사용 X
            //self.location = "/board/paging/read?bno="+"${boardVO.bno}";
        });

        // 목록버튼 클릭시
        $(".listBtn").on("click", function () {
            self.location = "/board/paging/list?page=${criteria.page}&perPageNum=${criteria.perPageNum}";
        });
